...
<div id="mobile-menu" class="hidden lg:hidden bg-base-100 shadow-md">
...
<!-- Menu untuk Mobile -->
<div id="mobile-menu" class="hidden lg:hidden bg-base-100 shadow-md px-4 py-2">
...
<div id="mobile-menu" class="lg:hidden hidden bg-base-100 shadow-md">
  <ul class="menu menu-vertical p-2">
    <?php if (!$this->session->userdata('user_id')): ?>
      <li><a href="<?= site_url('login') ?>" class="font-medium">Login</a></li>
      <li><a href="<?= site_url('register') ?>" class="font-medium">Register</a></li>
